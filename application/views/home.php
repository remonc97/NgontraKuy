                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="row">
                                <div class="col-lg-4"><img src="<?php echo base_url('assets/images/properties/1.jpg')?>" class="img-responsive" alt="properties"/></div>
                                <div class="col-lg-8">
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-lg-4"><img src="<?php echo base_url('assets/images/properties/2.jpg')?>" class="img-responsive" alt="properties"/></div>
                                <div class="col-lg-8">
                                    <h5><a href="property-detail.php">Integer sed porta quam</a></h5>
                                    <p class="price">$300,000</p>
                                    <a href="property-detail.php" class="more">More Detail</a>
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-lg-4"><img src="<?php echo base_url('assets/images/properties/3.jpg')?>" class="img-responsive" alt="properties"/></div>
                                <div class="col-lg-8">
                                    <h5><a href="property-detail.php">Integer sed porta quam</a></h5>
                                    <p class="price">$300,000</p>
                                    <a href="property-detail.php" class="more">More Detail</a>
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-lg-4"><img src="<?php echo base_url('assets/images/properties/4.jpg')?>" class="img-responsive" alt="properties"/></div>
                                <div class="col-lg-8">
                                    <h5><a href="property-detail.php">Integer sed porta quam</a></h5>
                                    <p class="price">$300,000</p>
                                    <a href="property-detail.php" class="more">More Detail</a>
