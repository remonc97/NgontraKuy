              ...
              <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo site_url('Inbox/lihatPesan/'.$item->idpenerima.'/'.$item->idpengirim) ?>" style="background-color: #1ac6ff; color: white" class="btn btn-default btn-circle" id="lihatPesan" data-toggle="modal"><i class="glyphicon glyphicon-envelope"></i> Lihat Pesan </a>
